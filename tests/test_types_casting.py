...
def test_ossis_type_parsers(type_name, input_value, expected):
    _type, _length, _precision, _scale, _element_type = ossisTypes.from_name(type_name)
...
if __name__ == "__main__":  # pragma: no cover
    ...
    for type_name, input_value, expected in CAST_TESTS:
        ...
        test_ossis_type_parsers(type_name, input_value, expected)
    print("okay")
