#!/usr/bin/env python3
"""
Comprehensive performance benchmark suite for comparing ossis versions.
...
Usage:
    ...
    compared across different versions of ossis.
"""
...
from ossis.dataframe import DataFrame
from ossis.schema import RelationSchema, FlatColumn
from ossis.types import ossisTypes


class PerformanceBenchmark:
    """Performance benchmark runner for ossis DataFrame operations."""
    
    def __init__(self):
        self.results: Dict[str, Any] = {
            "version": self._get_ossis_version(),
            "benchmarks": {}
        }
    
    def _get_ossis_version(self) -> str:
        """Get the current ossis version."""
        try:
            import ossis
            return ossis.__version__
    ...
    def benchmark_append_operations(self):
        ...
        schema2 = RelationSchema(
            ...
            columns=[
                ...
                FlatColumn(name='name', type=ossisTypes.VARCHAR),
                FlatColumn(name='value', type=ossisTypes.DOUBLE),
            ]
        )
    ...
    def run_all_benchmarks(self):
        """Run all benchmarks."""
        print("\n" + "=" * 80)
        print(f"ossis Performance Benchmark Suite - Version {self.results['version']}")
        print("=" * 80)
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Run ossis performance benchmarks")
