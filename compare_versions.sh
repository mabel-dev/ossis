#!/bin/bash
# Script to simplify version comparison benchmarking for ossis
#
# Usage:
...
echo "=========================================="
echo "ossis Version Performance Comparison"
echo "=========================================="
...
echo "=========================================="
pip install -q "ossis==$BASELINE_VERSION"
...
echo "=========================================="
pip install -q --upgrade "ossis==$CURRENT_VERSION"
