...
This module provides high-performance C++ and Cython implementations of column encoding schemes for the ossis data store.
...
```python
import numpy as np
from ossis.compute import rle_encode, rle_decode
...
```python
import numpy as np
from ossis.compute import dict_encode, dict_decode
